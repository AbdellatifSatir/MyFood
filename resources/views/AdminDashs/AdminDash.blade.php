                ...
                <div class="row justify-content-center">
                    <div class=" col-lg-10 col-md-8">
                        <div class="card p-3">
                            ...
                            <span><strong><center> Add Meal </center></strong></span><hr>
                            <br><br>

                            <form  class="form-card" method="POST" action="{{Route('AddMeal')}}" enctype="multipart/form-data">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        <div class="input-group"> <input type="text" name="title" placeholder="title"> <label>title</label> </div>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-12"> 
                                        <input type="submit" value="Add" class="btn btn-warning placeicon text-light"> 
                                    </div>
                                </div>
