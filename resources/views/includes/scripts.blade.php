...
<!-- isotope js -->
<script src="{{ asset('https://unpkg.com/isotope-layout@3.0.4/dist/isotope.pkgd.min.js') }}"></script>
<!-- nice select -->
...
<!-- Google Map -->
<script src="{{ asset('https://maps.googleapis.com/maps/api/js?key=AIzaSyCh39n5U-4IoWpsVGUHWdqB6puEkhRLdmI&callback=myMap') }}">
</script>
